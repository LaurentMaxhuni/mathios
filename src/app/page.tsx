...
export default function HomePage() {
  return (
    <div className="mx-auto w-full max-w-[1440px] px-4 py-7 sm:px-6 lg:px-10 lg:py-10">
      ...
      <section className="surface-grid relative mt-6 overflow-hidden rounded-2xl border bg-card px-6 py-8 shadow-soft sm:px-10 sm:py-10">
        <div
        ...
        <div className="relative max-w-3xl">
          ...
          <p className="mt-4 max-w-2xl text-base leading-7 text-muted-foreground sm:text-lg">
            Mathios is ready for feature work, with local-first runtime defaults, a portable data
            layer, and clear seams for the systems that come next.
          </p>
          <div className="mt-7 flex flex-wrap items-center gap-x-5 gap-y-3 text-sm text-muted-foreground">
            <span className="inline-flex items-center gap-2">
              <Activity className="h-4 w-4 text-accent" aria-hidden="true" /> Runnable foundation
            </span>
            <span className="inline-flex items-center gap-2">
              <ServerCog className="h-4 w-4 text-accent" aria-hidden="true" /> Offline-friendly by
              default
            </span>
          </div>
        </div>
      ...
      <section className="mt-8" aria-labelledby="systems-heading">
        <div className="flex flex-col justify-between gap-2 sm:flex-row sm:items-end">
          ...
          <p className="max-w-md text-sm leading-6 text-muted-foreground sm:text-right">
            Product modules will be added one phase at a time, without hiding unfinished learning
            flows behind empty screens.
          </p>
        </div>
