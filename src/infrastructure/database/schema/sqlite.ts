...
export const assessments = sqliteTable(
  "assessments",
  {
    ...
    partialCredit: integer("partial_credit", { mode: "boolean" }).notNull().default(true),
...
export const assessmentPools = sqliteTable(
  "assessment_pools",
  {
    id: text("id").primaryKey(),
    assessmentId: text("assessment_id")
...
export const assessmentSectionResults = sqliteTable(
...
export const simulationVersions = sqliteTable(
  "simulation_versions",
  {
    id: text("id").primaryKey(),
...
export const simulationInputs = sqliteTable(
  "simulation_inputs",
  {
...
export const simulationPresets = sqliteTable(
  "simulation_presets",
  {
    id: text("id").primaryKey(),
    simulationId: text("simulation_id")
...
export const lessonSimulations = sqliteTable(
  "lesson_simulations",
  {
    lessonId: text("lesson_id")
      .notNull()
...
export const userSimulationSessions = sqliteTable(
...
export const simulationResults = sqliteTable(
  "simulation_results",
  {
    id: text("id").primaryKey(),
...
export const laboratoryActivities = sqliteTable(
...
export const laboratorySteps = sqliteTable(
  "laboratory_steps",
  {
    id: text("id").primaryKey(),
...
export const laboratoryVariables = sqliteTable(
  "laboratory_variables",
  {
    ...
    theoreticalValue: real("theoretical_value"),
    configuration: text("configuration").notNull().default("{}"),
    sortOrder: integer("sort_order").notNull().default(0),
    createdAt: text("created_at")
      .notNull()
...
export const laboratorySessions = sqliteTable(
  "laboratory_sessions",
  {
    id: text("id").primaryKey(),
    profileId: text("profile_id")
...
export const laboratoryObservations = sqliteTable(
...
export const laboratoryMeasurements = sqliteTable(
...
export const laboratoryReports = sqliteTable(
  "laboratory_reports",
  {
    id: text("id").primaryKey(),
    sessionId: text("session_id")
...
export const laboratoryFeedback = sqliteTable(
  "laboratory_feedback",
  {
    id: text("id").primaryKey(),
...
export const searchRecentQueries = sqliteTable(
...
export const learnerMetrics = sqliteTable(
  "learner_metrics",
  {
    id: text("id").primaryKey(),
    profileId: text("profile_id")
    ...
    averageAssessmentScore: real("average_assessment_score").notNull().default(0),
    hintsUsed: integer("hints_used").notNull().default(0),
    attemptCount: integer("attempt_count").notNull().default(0),
    averageResponseTimeMs: real("average_response_time_ms").notNull().default(0),
...
export const contentMetrics = sqliteTable(
  "content_metrics",
  {
    ...
    accuracy: real("accuracy").notNull().default(0),
    averageResponseTimeMs: real("average_response_time_ms").notNull().default(0),
    averageAttempts: real("average_attempts").notNull().default(0),
    hintRate: real("hint_rate").notNull().default(0),
    discriminationIndex: real("discrimination_index").notNull().default(0),
