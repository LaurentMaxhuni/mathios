CREATE TABLE IF NOT EXISTS assessments (
  ...
  passing_threshold DOUBLE PRECISION NOT NULL DEFAULT 0.6 CHECK (passing_threshold >= 0 AND passing_threshold <= 1),
...
CREATE TABLE IF NOT EXISTS assessment_attempts (
  ...
  percentage DOUBLE PRECISION NOT NULL DEFAULT 0 CHECK (percentage >= 0 AND percentage <= 1),
  passed BOOLEAN,
...
ALTER TABLE question_attempts ALTER COLUMN exercise_attempt_id DROP NOT NULL;
ALTER TABLE question_attempts ADD COLUMN IF NOT EXISTS assessment_attempt_id TEXT REFERENCES assessment_attempts(id) ON DELETE CASCADE;
ALTER TABLE question_attempts ADD CONSTRAINT question_attempts_parent_check CHECK ((exercise_attempt_id IS NOT NULL) <> (assessment_attempt_id IS NOT NULL));
